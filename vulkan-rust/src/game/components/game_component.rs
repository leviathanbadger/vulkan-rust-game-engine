...
pub trait GameComponent : Debug + CanBeEnabled {
    ...
    fn render(&self, _device: &Device, _command_buffer: &vk::CommandBuffer, _pipeline_layout: &vk::PipelineLayout, _viewmodel: &glm::Mat4, _normal_viewmodel: Option<&glm::Mat4>) -> Result<()> {
        Ok(())
    }
}
